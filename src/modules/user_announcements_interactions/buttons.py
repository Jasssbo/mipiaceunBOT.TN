...
from src.config import CATEGORY_QUESTIONS, user_data, bot, CHAT_ID, YELLOW, GREEN, RED, RESET
...
from src.modules.topic_guardian import is_user_allowed_by_username
